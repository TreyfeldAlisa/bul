        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <h3 className={cn(interRegular.className, styles.textContentTop)}>
                    Computer vision not only takes data collection to the next level by opening
                    access to new data points from non-digitized sources, but also greatly expands
                    limits of content creation. Digitizing events brings content from all around the
                    world closer to end users.
                </h3>
